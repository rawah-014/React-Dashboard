        ...
        <SimpleBar className={`collapse ${showClass} sidebar d-md-block bg-primary text-white`}>
          <div className="sidebar-inner px-4 pt-3">
            ...
            <Nav className="flex-column pt-3 pt-md-0">
              ...
              <NavItem title="تقارير" link={Routes.DashboardOverview.path} icon={faChartPie} />
             {/*  <NavItem external title="Messages" link="https://demo.themesberg.com/volt-pro-react/#/messages" target="_blank" badgeText="Pro" icon={faInbox} /> */}
              ...
              {/*  <NavItem title="اضافة المنتجات " icon={faCog} link={Routes.Settings.path} /> */}
              {/* <NavItem title="المنتجات" icon={faCog} link={Routes.ProductTable.path} />  */}
              <NavItem title="الطلبات" icon={faCog} link={Routes.ListOrders.path} />
              {/*  <NavItem title="تفاصيل الطلبات" icon={faHandHoldingUsd} link={Routes.Transactions.path} />  */}
               <NavItem title="اضافة مستخدم" icon={faCog} link={Routes.NewUser.path} />   
              <NavItem title="المستخدمين" icon={faCog} link={Routes.Upgrade.path} />
              <NavItem title="اضافة منتج" icon={faCog} link={Routes.NewProduct.path} />
              {/* <NavItem title="اضافة " icon={faCog} link={Routes.NewImage.path} /> */}
              <NavItem title="قائمة المنتجات" icon={faCog} link={Routes.ProductsList.path} /> 
                <NavItem title="اضافة معلومات التواصل" icon={faCog} link={Routes.AddInfo.path} />  
              <NavItem title="معلومات التواصل" icon={faCog} link={Routes.InfosList.path} /> 
              <NavItem title="اضافة العروض" icon={faCog} link={Routes.NewOffer.path} />
              <NavItem title="قائمة العروض" icon={faCog} link={Routes.OffersList.path} /> 
